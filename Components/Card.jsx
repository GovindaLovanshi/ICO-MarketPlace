        ...
        features.map((feature,index)=>(
          ...
          <p style={{
            ...
            <button className="card-btn" style={{
             ...
             ? setIcoMarketplaceContract() : feature.title=="Create Token" ? setTokenCreator(true)
             ? feature.title == "History ? setOpenTokenHistory(true) : feature.title=="Transfer  Token"?
             setOpenTransferToken(true): feature.title == "Withdraw Token" ?
             setOpenWithdrawToken(true):feature.title == "ICO ADDRESS" ? copyAddress():feature.title =="Create ICO"? setOpenCreateIco(true) :""}
            }>
            {feature.btnName}</button>
          </div>
        ))
       }
     </div>
